          ...
          <div className="prose prose-neutral max-w-none">
            <section className="mb-8">
              ...
              <p className="text-neutral-600 leading-relaxed">
                Welcome to SmartInboxAI ("we," "our," or "us"). We are committed to protecting your privacy and ensuring 
            ...
            <section className="mb-8">
              ...
              <p className="text-neutral-600 leading-relaxed">
                SmartInboxAI's use and transfer of information received from Google APIs adheres to the{' '}
                <a 
            ...
            <section className="mb-8">
              ...
              <p className="text-neutral-600 leading-relaxed">
                SmartInboxAI is not intended for users under 13 years of age. We do not knowingly collect 
