...
export default function LandingPage() {
  ...
  const faqs = [
    {
      question: 'How does SmartInboxAI learn my writing style?',
      answer:
        'SmartInboxAI analyzes tone, phrase choices, and sentence patterns from your sent emails, then adapts suggestions to match your natural communication style over time.',
    },
    {
      ...
      <section id="testimonials" className="relative py-24 px-4">
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              {
                quote: "SmartInboxAI has transformed how I handle my 200+ daily emails. The AI summaries alone save me 2 hours every day.",
                author: "Sarah Chen",
        ...
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              <span className="text-lg font-bold text-neutral-900 font-display">SmartInboxAI</span>
            </div>
            <p className="text-neutral-500">
              &copy; 2026 SmartInboxAI. Crafted with care.
            </p>
