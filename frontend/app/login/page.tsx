  ...
  return (
    <div className="bg-mesh min-h-screen font-sans">
      <div className="min-h-screen flex">
        {/* Left Side - Branding */}
        <div className="relative hidden overflow-hidden bg-slate-950 p-10 text-white lg:flex lg:w-[45%]">
          {/* Gradient Overlay */}
          ...
          <div className="relative z-10 flex flex-col h-full">
            ...
            <Link href="/" className="flex items-center gap-3">
              ...
              <span className="text-xl font-bold font-display tracking-tight">SmartInboxAI</span>
            </Link>
        ...
        <div className="flex w-full items-center justify-center p-6 sm:p-8 lg:w-[55%]">
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <div className="flex items-center justify-center gap-3 mb-10 lg:hidden">
              ...
              <span className="text-2xl font-bold text-neutral-900 font-display tracking-tight">SmartInboxAI</span>
            </div>
