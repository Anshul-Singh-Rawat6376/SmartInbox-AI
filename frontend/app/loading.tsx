...
export default function Loading() {
  ...
  return (
    <div className="bg-mesh flex min-h-screen items-center justify-center px-4 font-sans">
      ...
      <div className="relative z-10 w-full max-w-md text-center">
        ...
        >
          <h2 className="mb-1 text-lg font-semibold tracking-tight text-neutral-900 font-display">
            SmartInboxAI
          </h2>
