    ...
    <div className="min-h-screen bg-neutral-50 font-sans">
        ...
        <div className="max-w-4xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <Link href="/" className="flex items-center gap-3">
              ...
              <span className="text-lg font-bold text-neutral-900 font-display tracking-tight">SmartInboxAI</span>
            </Link>
            <Link href="/">
              <motion.button
          ...
          <div className="prose prose-neutral max-w-none">
            <section className="mb-8">
              ...
              <p className="text-neutral-600 leading-relaxed">
                By accessing or using SmartInboxAI ("Service"), you agree to be bound by these Terms of Service 
            ...
            <section className="mb-8">
              ...
              <p className="text-neutral-600 leading-relaxed">
                SmartInboxAI is an AI-powered email management service that helps users organize, prioritize, 
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-neutral-600 space-y-2">
                ...
                <li>Authorize SmartInboxAI to access your Gmail account</li>
            ...
            <section className="mb-8">
              ...
              <p className="text-neutral-600 leading-relaxed">
                The Service and its original content, features, and functionality are owned by SmartInboxAI 
            ...
            <section className="mb-8">
              ...
              <p className="text-neutral-600 leading-relaxed">
                You agree to indemnify and hold harmless SmartInboxAI and its officers, directors, employees, 
      ...
      <footer className="border-t border-neutral-200 bg-white py-6">
        <div className="max-w-4xl mx-auto px-6 text-center text-neutral-500 text-sm">
          <p>&copy; {new Date().getFullYear()} SmartInboxAI. All rights reserved.</p>
